...
TMaxMatrixH30=zeros(15000000,1);
t=linspace(0.04,600,15000000);
%res=zeros(1000000,1);

%25000次為一秒
for q=1:15000000 %10min
    %Tmax=0;
    next_time_step=A*current_time_step+const;
    
    for r=1:661
        if next_time_step(r)>TMaxMatrixH30(q)
            TMaxMatrixH30(q)=next_time_step(r);
        end
